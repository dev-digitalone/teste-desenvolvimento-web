  ...
  <section class="container py-4">
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <small class="my-2 form-text text-muted"><a class="text-dark" href="Cadastro.php">Criar uma nova conta</a></small>

        <small class="text-muted"><a class="text-dark" href="Login.php">Voltar ao login</a></small>
      </div>
    </div>
  </section>
